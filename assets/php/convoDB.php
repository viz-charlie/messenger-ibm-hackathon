<?php
	...
	$convodb = new mysqli($mysql_server_name, $mysql_username, $mysql_password, $mysql_database);
	if ($convodb->connect_errno) {
		echo "Failed to connect to MySQL: (" . $convodb->connect_errno . ") " . $convodb->connect_error;
		die();
	}								
?>