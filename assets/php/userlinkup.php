<?php
	...
	$conul = new mysqli($mysql_server_name, $mysql_username, $mysql_password, $mysql_database);
	if ($conul->connect_errno) {
		echo "Failed to connect to MySQL: (" . $conul->connect_errno . ") " . $conul->connect_error;
		die();
	}								
?>
